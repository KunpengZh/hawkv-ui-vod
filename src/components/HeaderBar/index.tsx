...
function HeaderBar({ headerMenuList, eventHandler }: HeaderBarProps) {
    ...
    return <div className={styles.headerBar}>
        <img src='/hawk.svg' height="45px" width="45px" />
        ...
        <Space className={styles.rightContainer} size="large">
            <Dropdown placement="bottomLeft" overlay={ShoppingCart}><img src="/shoppingcart.svg" height="20px" width="20px" /></Dropdown>
            <Avatar src='/user.svg' size="small" className={styles.avatar} />
